...
public class CrateSpawner : MonoBehaviour
{
    ...
    public static List<Vector3> cratePositions = new List<Vector3>();  // List to store crate positions
    ...
    public void Spawn1(float amt)
    {
        for(int i = 0; i < amt; i++)
        {
            ...
            // spawnArea1 = new Vector3(spawn1x_min, spawn1y, spawn1z_min);
            Instantiate(crate, spawnArea1, Quaternion.identity);
            cratePositions.Add(spawnArea1);  // Store crate position
        }
    }
    ...
    public void Spawn2(float amt)
    {
        for (int i = 0; i < amt; i++)
        {
            // spawnArea2 = new Vector3(spawn2x_min, spawn2y, spawn2z_min);
            ...
            cratePositions.Add(spawnArea2);  // Store crate position
        }
    }
    ...
    public void Spawn3(float amt)
    {
        for (int i = 0; i < amt; i++)
        {
            // spawnArea3 = new Vector3(spawn3x_min, spawn3y, spawn3z_min);
            ...
            cratePositions.Add(spawnArea3);  // Store crate position
        }
    }
}
